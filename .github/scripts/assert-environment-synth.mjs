...
const expected = ['BackendStack', 'FrontendStack', 'AuthStack', 'EcsExpressStack', 'FrontendConfigStack', 'CloudWatchDashboardStack']
...
for (const [other, otherConfig] of Object.entries(map)) {
  ...
  const forbidden = ['BackendStack', 'FrontendStack', 'AuthStack', 'EcsExpressStack', 'FrontendConfigStack', 'CloudWatchDashboardStack']
